...
pub struct TradeInfo {
    ...
    pub collateral_price_usd: Decimal,
}
...
pub const COLLATERALS: Item<HashMap<String, u64>> = Item::new("collaterals");
pub const TRADES: Item<HashMap<(Addr, u64), Trade>> = Item::new("trades");
pub const TRADE_INFOS: Item<HashMap<(Addr, u64), TradeInfo>> =
    Item::new("trade_infos");
pub const TRADE_PENDING_ORDERS_BLOCK: Item<
    HashMap<(Addr, u64, PendingOrder), u64>,
> = Item::new("pending_orders");
pub const PENDING_ORDERS: Item<HashMap<(Addr, u64), PendingOrder>> =
    Item::new("pending_orders");
pub const TRADER_STORED: Item<HashMap<Addr, bool>> = Item::new("trader_stored");
...
//     pub limit_order_last_success: HashMap<Addr, u64>,
...
//         if trade.buy && trade.open_price > wanted_price + max_slippage {
//             return Err(ContractError::TradeInvalid);
//         }
...
//         if !self.within_exposure_limits(
//             trade.pair_index,
//             trade.buy,
//             trade.position_size_nusd,
//             trade.leverage,
//         ) {
//             return Err(ContractError::OutsideExposureLimits);
//         }
...
//         let token_price_nusd =
//             self.get_token_price_nusd(deps, trade.pair_index)?;
...
//     fn get_token_price_nusd(
//         &self,
//         deps: QuerierWrapper,
//         pair_index: u64,
//     ) -> Result<Decimal256, ContractError> {
//         let query_msg = OracleQueryMsg::GetPrice { pair_index };
//         let request: WasmQuery = WasmQuery::Smart {
//             contract_addr: self.oracle_address.to_string(),
//             msg: to_json_binary(&query_msg)?,
//         };

//         let res: Decimal256 = deps.query(&QueryRequest::Wasm(request))?;
//         return Ok(res);
//     }
...
// pub fn within_exposure_limits(
//     pair_index: u64,
//     collateral_index: u8,
//     long: bool,
//     position_size_nusd: Uint256,
// ) -> Result<(), ContractError> {
//     todo!();

//     let default = [Decimal256::zero(), Decimal256::zero(), Decimal256::zero()];
